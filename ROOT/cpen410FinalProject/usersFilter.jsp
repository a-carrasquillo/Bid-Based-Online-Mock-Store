...
<%
	...
	if((session.getAttribute("userName")==null) || (session.getAttribute("currentPage")==null)) {
		...
		String currentPage="usersFilter.jsp";
		...
		try {
			...
			if(appDBAuth.verifyUserPageAccess(userName, currentPage)) {
				...
				if(res.next()) {
					...
					session.setAttribute("currentPage", "usersFilter.jsp");
					...
					if(search_filter.isEmpty()) {
						...
						session.setAttribute("userName", null);
						session.setAttribute("filter", null);
						System.out.println("User search filter not recognized. Redirecting to login page...");
						// return to the login page
						response.sendRedirect("login.jsp");
					}
